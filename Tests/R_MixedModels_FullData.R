...
fullData$values = matlabData$linearProjectedMeasure[1, 1]

# Mixed Models
library(lme4)

tempfit <- lmer(values ~ groups*sessions*cond_motions*cond_orders*(1|subjects), data=fullData)
...
#   }
#   
#   tempfit <- aov(values ~ groups*sessions*cond_motions*cond_orders*(1|subjects), data=fullData)
#   
#   summary(tempfit)
# }
